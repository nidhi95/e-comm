...
const variantClasses = {
  ...
  body5: "lg:text-[11px] xl:text-[13px] text-[15px] 3xl:text-[18px]",
  body6: "lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px]",
  body7: "lg:text-[10px] xl:text-[11px] text-[13px] 3xl:text-[15px]",
  body8: "xl:text-[10px] text-[12px] 3xl:text-[14px] lg:text-[9px]",
};
