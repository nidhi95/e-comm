  ...
  return (
    <>
      <footer className={props.className} compid="13:2603" comptype="Footer">
        <Row
          className="items-center lg:mb-[22px] xl:mb-[28px] 2xl:mb-[32px] 3xl:mb-[38px] 3xl:ml-[116px] lg:ml-[69px] xl:ml-[86px] 2xl:ml-[97px] 2xl:mr-[100px] 3xl:mr-[120px] lg:mr-[71px] xl:mr-[88px] lg:mt-[27px] xl:mt-[34px] 2xl:mt-[39px] 3xl:mt-[46px] w-[86%]"
          compid="110"
          comptype="Row"
        >
          <Column className="w-[68%]" compid="109" comptype="Column">
            <Img
            ...
            >
              ...
              >
                ...
                <Text
                  className="font-inter font-normal lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] not-italic text-gray_500 w-[auto]"
              ...
              >
                ...
                <Text
                  className="font-inter font-normal lg:mt-[12px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] not-italic text-gray_500 w-[auto]"
                ...
                <Text
                  className="font-inter font-normal lg:mt-[15px] xl:mt-[19px] 2xl:mt-[22px] 3xl:mt-[26px] not-italic text-gray_500 w-[auto]"
                ...
                <Text
                  className="font-inter font-normal lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] not-italic text-gray_500 w-[auto]"
                ...
                <Text
                  className="font-inter font-normal lg:mt-[16px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] not-italic text-gray_500 w-[auto]"
              ...
              >
                ...
                >
                  <Img
                    ...
                    compid="I13:2841;61:718;60:551;13:5774"
                    comptype="Image"
                    alt="camera"
                  />
                  <Text
                    className="font-inter font-normal 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] mt-[3px] not-italic text-gray_500 w-[auto]"
                ...
                >
                  <Img
                    ...
                    compid="I13:2841;60:553;60:551;13:8886"
                    comptype="Image"
                    alt="facebook"
                  />
                  <Text
                    className="font-inter font-normal 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] not-italic text-gray_500 w-[auto]"
                ...
                >
                  <Img
                    ...
                    compid="I13:2841;60:554;60:551;13:8937"
                    comptype="Image"
                    alt="play"
                  />
                  <Text
                    className="font-inter font-normal 3xl:ml-[10px] lg:ml-[6px] xl:ml-[8px] 2xl:ml-[9px] my-[1px] not-italic text-gray_500 w-[auto]"
            ...
            <Text
              className="font-inter font-medium ml-[1px] lg:mt-[42px] xl:mt-[53px] 2xl:mt-[60px] 3xl:mt-[72px] text-white_A700 w-[auto]"
            ...
            <Text
              className="font-inter font-normal ml-[1px] lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] text-white_A700 w-[auto]"
          ...
          <Column className="w-[32%]" compid="108" comptype="Column">
            <Text
            ...
            <Text
              className="font-inter font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] not-italic text-white_A700 w-[auto]"
            ...
            >
              <Img
                ...
                className="lg:h-[13px] xl:h-[16px] 2xl:h-[18px] 3xl:h-[21px] w-[5%]"
                compid="I13:2841;102:332;13:2321"
                comptype="Image"
                alt="checkmark"
              />
              <Text
                className="font-inter font-normal lg:ml-[12px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] not-italic text-gray_500 w-[auto]"
            ...
            <Text
              className="font-inter font-normal lg:leading-[12px] xl:leading-[16px] 2xl:leading-[18px] 3xl:leading-[21px] lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] not-italic text-gray_500 w-[91%]"
            ...
            <Text
              className="font-inter font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] not-italic text-gray_500 w-[auto]"
            ...
            <Text
              className="lg:mt-[31px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] AboutRapidbox1"
